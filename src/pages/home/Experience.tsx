      ...
      <div className="w-full text-[var(--color-primary)]">
        ...
        <div className="relative flex flex-col gap-16">
          <div className="relative">
            ...
            <div className="absolute left-[0.35rem] top-4 h-[120%] w-0.5 bg-[var(--color-primary)]" />
            ...
            <div className="w-full pl-8">
              ...
              <div className="mb-6">
                <h4 className="mb-3 text-xl font-semibold text-[var(--color-primary)]">
                  검색 중심 서비스 구조 및 SEO 설계
                </h4>
                <ul className="space-y-3 text-lg opacity-80">
                  <li>
                    Next.js 기반 웹 서비스에서 검색 노출을 고려한 페이지 구조
                    설계 및 SEO 요구사항 반영
                  </li>
                  <li>
          ...
          <div className="relative">
            {/* dot */}
            <div className="absolute left-1.5 top-3 h-3 w-3 -translate-x-1/2 rounded-full bg-[var(--color-primary)] shadow-[0_0_12px_var(--color-primary)]" />
            <div className="absolute left-[0.35rem] top-4 h-full w-0.5 bg-[var(--color-primary)]" />
